...
//  Header      Class ID    len         msgV  nHw   nUse   nCB
//                                      0     1     2     3     
//  ----------  ----------  ----------  ----  ----  ----  ----  
    0xB5, 0x62, 0x06, 0x3E, 0x3C,0x00,  0x00, 0x20, 0x20, 0x07, 
    
//  gId   rTC   mTC   res   flags (byte0:bit0=enable, do not forget about the checksum)
//  ----  ----  ----  ----  ----------------------
    ...
    0x06, 0x08, 0x0E, 0x00, 0x00, 0x00, 0x01, 0x01, // None
//  CK_A  CK_B    
    0x53, 0x17                                      
};
